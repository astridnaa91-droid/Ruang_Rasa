        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-2 text-amber-600 font-bold text-lg tracking-wide">
                        ...
                        <span class="font-serif font-black text-xl text-amber-800">Ruang Rasa</span>
                    </a>
                </div>
